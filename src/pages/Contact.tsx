...
export function Contact() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#F7F7F7] overflow-hidden flex-1">
      <Helmet>
      ...
      <FluidParticlesBackground className="pointer-events-none opacity-20" speedMultiplier={0.2} particleCount={100} />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-20 pt-12 pb-24 md:pt-20 md:pb-32">
        ...
        >
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-[#1A1A1A] tracking-tight mb-6">
            Let's Talk
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-24">
          ...
          <div className="flex flex-col gap-12">
            ...
            >
              ...
              <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm relative overflow-hidden group hover:border-gray-300 hover:shadow-md transition-all">
                <div className="flex flex-col items-center justify-center text-center py-8">
                  <div className="w-16 h-16 rounded-2xl bg-cyan-50 flex items-center justify-center border border-cyan-100 text-cyan-600 mb-6">
                    <CalendarDays className="w-8 h-8" />
                  </div>
                  <h3 className="text-xl font-semibold text-[#1A1A1A] mb-2">Book your free strategy session</h3>
                  <p className="text-gray-600 mb-8 max-w-md">Pick a time that works for you. We'll take it from there.</p>
                  
                  <a href="https://calendly.com/openbrand-marketing/30min" target="_blank" rel="noopener noreferrer" className="relative group inline-flex items-center justify-center gap-2 bg-cyan-500 text-white px-8 py-4 rounded-xl font-bold hover:bg-cyan-600 transition-all shadow-sm hover:shadow">
                    Open Calendar
            ...
            >
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col gap-6 shadow-sm">
                <a href="mailto:twijjukyeanan00@gmail.com" className="flex items-center gap-4 text-gray-600 hover:text-[#1A1A1A] transition-colors group">
                ...
                <a href="tel:+256754593472" className="flex items-center gap-4 text-gray-600 hover:text-[#1A1A1A] transition-colors group">
                  <div className="w-12 h-12 rounded-full bg-gray-50 flex items-center justify-center group-hover:bg-gray-100 transition-colors">
                ...
                <div className="pt-4 border-t border-gray-200 flex items-center gap-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#0A66C2] transition-colors">
                    <Globe className="w-5 h-5" />
                  </a>
                  <a href="#" className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#1A1A1A] transition-colors">
          ...
          >
            <h2 className="text-2xl font-bold text-[#1A1A1A] mb-6">Or send us a message</h2>
              ...
              >
                ...
                <div>
                  ...
                  <input 
                    ...
                    name="name"
                    required
                    className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-[#1A1A1A] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    required
                    rows={4}
                    className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-[#1A1A1A] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all resize-none"
                    placeholder="Tell us about your current lead generation..."
                  ></textarea>
                </div>
                <button type="submit" className="w-full relative group inline-flex items-center justify-center gap-2 bg-[#1A1A1A] text-white px-8 py-4 rounded-xl font-bold hover:bg-black transition-all mt-2">
                  Send Message
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </button>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {faqs.map((faq, idx) => (
              <div key={idx} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-gray-300 hover:shadow-md transition-all">
