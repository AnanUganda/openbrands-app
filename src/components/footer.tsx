...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Predictable Leads</span> <span className="text-cyan-500/60">✦</span>
    <span>Proven Processes</span> <span className="text-white/30">✦</span>
    <span>Data-Driven Strategy</span> <span className="text-cyan-500/60">✦</span>
    <span>Measurable Growth</span> <span className="text-white/30">✦</span>
    <span>Exclusive Network</span> <span className="text-cyan-500/60">✦</span>
  </div>
);
        ...
        <footer className="fixed bottom-0 left-0 flex h-[80vh] min-h-[600px] w-full flex-col justify-between overflow-hidden bg-black text-white cinematic-footer-wrapper">
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-white/10">
              <span className="text-zinc-400 text-[10px] md:text-xs font-bold uppercase tracking-widest">Built for</span>
              <span className="animate-footer-heartbeat text-sm md:text-base text-cyan-400">✦</span>
              <span className="text-zinc-400 text-[10px] md:text-xs font-bold uppercase tracking-widest">Growth</span>
            </div>
